...
>
  <div className="relative w-full md:w-auto">
    ...
    <ShinyButton
      ...
      className="w-full md:w-auto justify-center relative px-6 py-3 md:py-2 text-base font-bold shadow-lg shadow-primary/20 bg-primary text-black border-primary/50"
    >
  ...
  <a
    ...
    className="w-full md:w-auto inline-flex items-center justify-center gap-2 rounded-full border border-primary/30 bg-primary/5 backdrop-blur-xl px-8 py-4 md:py-2 text-base font-medium hover:bg-primary/10 hover:border-primary/40 transition-colors whitespace-nowrap"
  >
    Buy now - €3,200
