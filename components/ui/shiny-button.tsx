...
>(({ children, className, asChild, ...props }, ref) => {
  ...
  // If asChild, just apply styles to the child without motion effects
  ...
  // Normal button with full shiny effect
  return (
    <motion.button
      ref={ref}
    ...
    >
      <span
        className="relative flex items-center justify-center gap-2 w-full tracking-wide"
        style={{
          maskImage:
